...
interface CampaignPreviewProps {
  ...
  followStepMessage: string;
  followStepButtonLabel: string;
        ...
        {openingDmEnabled && followStepEnabled && (
          <>
            <div className="flex items-end gap-2">
              <Avatar url={avatarUrl} size={24} />
              <div className="max-w-[80%] overflow-hidden rounded-2xl rounded-bl-md bg-zinc-800">
                <p className="whitespace-pre-wrap px-3 py-2 text-sm">{followStepMessage || "Your follow-step message…"}</p>
                <div className="mx-1.5 mb-1.5 rounded-xl bg-zinc-700 px-4 py-1.5 text-center text-sm font-medium text-white">
                  {followStepButtonLabel || "Button label"}
                </div>
              </div>
            </div>
            <div className="flex justify-end">
      ...
      <Phone>
        ...
        {tab === "dm" && (
          <DmScreen
            ...
            followStepEnabled={props.followStepEnabled}
            followStepMessage={props.followStepMessage}
            followStepButtonLabel={props.followStepButtonLabel}
