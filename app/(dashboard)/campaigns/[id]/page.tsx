...
export default function CampaignDetailPage() {
  ...
  const metrics: Array<{ label: string; value: string | number; tone: StatTone }> = [
    { label: "Sends", value: campaign.analytics.sent, tone: "sent" },
    { label: "Clicks", value: campaign.analytics.clicks, tone: "clicks" },
    { label: "CTR", value: `${campaign.analytics.ctr}%`, tone: "ctr" },
    { label: "Failed", value: campaign.analytics.failed, tone: "failed" },
  ];
  ...
  return (
    <div className="grid gap-6 lg:grid-cols-[minmax(0,340px)_1fr]">
      ...
      <div className="space-y-6">
        ...
        {campaign.openingDmEnabled && campaign.followStepEnabled && (
          <Summary title="Then, they will get a follow reminder">
            <FieldBox>{campaign.followStepMessage || "Follow reminder"}</FieldBox>
            <FieldBox>{campaign.followStepButtonLabel || "Button"}</FieldBox>
          </Summary>
        )}
      ...
      <div className="space-y-4">
        ...
        {tab === "preview" && (
          ...
          <CampaignPreview
            ...
            followStepEnabled={campaign.followStepEnabled}
            followStepMessage={campaign.followStepMessage ?? ""}
            followStepButtonLabel={campaign.followStepButtonLabel ?? ""}
