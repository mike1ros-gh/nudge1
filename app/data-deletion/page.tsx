...
export const metadata: Metadata = {
  title: "Data Deletion - Nudge1",
  description:
    "How Nudge1 customers can disconnect Instagram and request account or campaign data deletion.",
};
...
export default function DataDeletionPage() {
  return (
    <LegalShell
      title="Data Deletion"
      description="Use this page for Meta App Review and customer requests about removing Nudge1 account, workspace, Instagram, and campaign data."
